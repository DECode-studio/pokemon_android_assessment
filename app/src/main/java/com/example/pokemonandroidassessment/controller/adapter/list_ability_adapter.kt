...
class ListAbilityAdapter(context: Context, private val resource: Int, private val pokemons: List<AbilitiesItem>) :
    ArrayAdapter<AbilitiesItem>(context, resource, pokemons) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {1
        ...
        holder.textViewPokemonName?.text = pokemon.ability!!.name
